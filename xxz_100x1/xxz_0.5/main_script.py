...
h = 0.5 # strength of z interactions
alpha = 5 # number of RBM features
iterations = 10001 # number of parameter updates
...
if rgn:
    ...
    for iteration in range(iterations):
        ...
        if d <= 20:
            ...
            print('Exact error: ', (rgn_exact[iteration] - soln[0][0])/d)
...
if sr:
    ...
    for iteration in range(iterations):
        ...
        if d <= 20:
            ...
            print('Exact error: ', (sr_exact[iteration] - soln[0][0])/d)
